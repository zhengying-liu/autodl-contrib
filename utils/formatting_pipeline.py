...
def add_entry_doc(input_dir, dataset_name, score, filename='doc.tex'):
    ...
    value = parse_info(public_info + private_info, 'past_usage').replace("'", "")
    f.write(value + ' \\\\\n')

    f.write('{\\bf Description:}\n')
    value = parse_info(public_info + private_info, 'description').replace("'", "")
    f.write(value + ' \\\\\n')

    f.write('{\\bf Preparation:}\n')
    value = parse_info(public_info + private_info, 'preparation').replace("'", "")
    f.write(value + ' \\\\\n')

    f.write('{\\bf Representation:}\n')
    value = parse_info(public_info + private_info, 'representation').replace("'", "")
    f.write(value + ' \\\\\n')
